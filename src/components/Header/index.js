...
// making an object of pages for the navbar section so that we can pass another dynamically here.
const navigations = [
  {
    name: "Home",
    path: "/",
  ...
  return (
    <header className="text-gray-600 body-font shadow-lg">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <Link
          to={"/signup"}
          className="inline-flex items-center text-white bg-indigo-500 border-0 py-1 px-3 focus:outline-none hover:bg-indigo-700 rounded text-base mt-4 mr-2 md:mt-0"
        >
          Login / Sign Up
          <svg
            fill="none"
